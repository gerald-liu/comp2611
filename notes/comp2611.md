...
| ---------------------------- | --------------------------- |
| ![](1-bit_ALU_0.png)         | ![](1-bit_ALU_31.png)       |
...
<img src="4-bit_carry_lookahead_adder.svg" width="400"/>
...
| ----------------------- | --------------------- | ----------------- |
| ![](mult_algo.png)      | ![](booth_algo.png)   | ![](div_algo.png) |
...
| ----------- | -------------- |
| ![](ALU_controls.png) | ![](ALU_control_circ.png) |

### Controls

![](processor.png)

![](controls_truth_table.png)

![](controls_def.png)

### Hazards

![](processor_hazards.png)
